...
Program.create!(program_title: "Paper Airplanes", program_description: Faker::Hipster.sentences(10).join(" "), program_fee: 0, image_title: "airplane", topics: "energy, forces", group_size_min: 10, group_size_max: 20, time_am: "09:30:00", time_pm: "14:30:00", user_id: 2, category_id: 2, delivery_mode_id: 1, school_level_id: 6)
Program.create!(program_title: "Air Pressure", program_description: Faker::Hipster.sentences(10).join(" "), program_fee: 0, image_title: "pressure build up", topics: "energy, atmospheric pressure, surface area", group_size_min: 10, group_size_max: 50, time_am: "09:30:00", time_pm: "14:30:00", user_id: 3, category_id: 2, delivery_mode_id: 2, school_level_id: 3)
